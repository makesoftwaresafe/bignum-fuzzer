...
fuzzer: fuzzer.cpp runner.cpp runner.h multi.cpp multi.h input.cpp input.h
	...
	$(CXX) $(CXXFLAGS) fuzzer.o multi.o runner.o input.o libFuzzer.a modules/openssl/module.a modules/go/module.a modules/cpp_boost/module.a modules/rust/module.a modules/chicken/module.a -lpthread -o bnfuzzer
